...
// Variant unprefixed, so an entry reads `ty: Scheme(scheme::range)`.
use crate::typecheck::builtins::BuiltinTypeRule;
use crate::typecheck::builtins::BuiltinTypeRule::Scheme;
...
builtin_registry! {
    Clear { names: ["clear"], ty: Scheme(scheme::terminal_control),
    ...
    Reset { names: ["reset"], ty: Scheme(scheme::terminal_control),
    ...
    Range { names: ["range"], ty: Scheme(scheme::range),
    ...
    Fail { names: ["fail"], ty: Scheme(scheme::fail),
    ...
    Exit { names: ["exit", "quit"], ty: Scheme(scheme::exit),
    ...
    Warn { names: ["warn"], ty: Scheme(scheme::string_to_unit),
    ...
    FromBytes { names: ["from-bytes"], ty: Scheme(scheme::from_bytes),
    ...
    FromString { names: ["from-string"], ty: Scheme(scheme::from_string),
    ...
    FromLine { names: ["from-line"], ty: Scheme(scheme::from_string),
    ...
    FromLines { names: ["from-lines"], ty: Scheme(scheme::from_lines),
    ...
    ToBytes { names: ["to-bytes"], ty: Scheme(scheme::to_bytes),
    ...
    IntsToBytes { names: ["ints-to-bytes"], ty: Scheme(scheme::ints_to_bytes),
    ...
    ToString { names: ["to-string"], ty: Scheme(scheme::to_any_bytes),
    ...
    ToLine { names: ["to-line"], ty: Scheme(scheme::to_line),
    ...
    ToLines { names: ["to-lines"], ty: Scheme(scheme::to_lines),
    ...
    Chdir { names: ["cd"], ty: Scheme(scheme::chdir),
    ...
    Alias { names: ["alias"], ty: Scheme(scheme::alias),
    ...
    Unalias { names: ["unalias"], ty: Scheme(scheme::unalias),
    ...
    Exists { names: ["exists"], ty: Scheme(scheme::path_bool),
    ...
    Help { names: ["help"], ty: Scheme(scheme::help),
    ...
    Explain { names: ["explain"], ty: Scheme(scheme::explain),
