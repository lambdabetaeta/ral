...
const DOOR_MANIFEST: &[(&str, &str)] = &[
    ...
    ("core/src/builtins/predicates.rs", "io-door:silent:stat-follow"),
    ("core/src/builtins/predicates.rs", "io-door:silent:stat-nofollow"),
    ("core/src/builtins/predicates.rs", "io-door:silent:writable-stat-nonunix"),
    ...
    ("core/src/host.rs", "io-door:silent:prelude-bake"),
    ("core/src/path/which.rs", "io-door:silent:which-readdir"),
    ("core/src/path/which.rs", "io-door:silent:which-stat"),
    ("core/src/runtime/command/redirect.rs", "io-door:surface:atomic-commit"),
    ("core/src/runtime/command/redirect.rs", "io-door:surface:atomic-eligible"),
    ("core/src/runtime/command/redirect.rs", "io-door:surface:open-atomic"),
    ("core/src/runtime/command/redirect.rs", "io-door:surface:open-file"),
    ("core/src/runtime/command/redirect.rs", "io-door:surface:stdin-redirect"),
    ("core/src/runtime/command/uutils.rs", "io-door:silent:uutils-cwd-restore"),
    ("core/src/runtime/command/uutils.rs", "io-door:silent:uutils-cwd-save"),
    ("core/src/runtime/pipeline/helper.rs", "io-door:silent:self-reexec-windows"),
    ...
    ("core/src/sandbox/diag/linux.rs", "io-door:silent:journal-read"),
    ...
    ("core/src/subprocess_codec.rs", "io-door:silent:frame-dump-nonunix"),
    ...
    ("exarch/src/host.rs", "io-door:silent:date-launch"),
    ("exarch/src/host.rs", "io-door:silent:git-launch"),
    ("exarch/src/models.rs", "io-door:silent:models-cache-read"),
    ("exarch/src/models.rs", "io-door:silent:models-cache-write"),
    ("exarch/src/oauth/browser.rs", "io-door:silent:browser-launch"),
    ("exarch/src/oauth/browser.rs", "io-door:silent:browser-launch-linux"),
    ...
    ("exarch/src/oauth/mod.rs", "io-door:silent:token-write-nonunix"),
